...
; 0000 0061     num_int_called++;
	LDI  R26,LOW(_num_int_called_S0000001000)
	LDI  R27,HIGH(_num_int_called_S0000001000)
	LD   R30,X+
	LD   R31,X+
	ADIW R30,1
	ST   -X,R31
...
; 0000 006D         num_int_called=0;
	LDI  R30,LOW(0)
	STS  _num_int_called_S0000001000,R30
	STS  _num_int_called_S0000001000+1,R30
; 0000 006E     }
; 0000 006F 
; 0000 0070 }
_0xD:
...
SUBOPT_0x0:
	...
	LSR  R31
	ROR  R30
	LDS  R26,_num_int_called_S0000001000
	LDS  R27,_num_int_called_S0000001000+1
	CP   R26,R30
	CPC  R27,R31
	RET
